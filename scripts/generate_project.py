#!/usr/bin/env python3
"""Generate KidsTamil Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\KidsTamil")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "kidstamil"
TEST = APP / "src" / "test" / "java" / "com" / "kidstamil"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "kidstamil"
...
android {
    namespace = "com.kidstamil"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.kidstamil.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.kidstamil.data.** { *; }
-keep class com.kidstamil.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "kidstamil-game",
    "storage_bucket": "kidstamil-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.kidstamil.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating KidsTamil project files...")
