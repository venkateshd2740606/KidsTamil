...
1. Open `D:\Work\Games\KidsTamil` in Android Studio.
...
The project is scaffolded from PuzzleVerse. Replace `engine/ScrewPuzzleEngine.kt` with `KidsTamilEngine.kt` (tube pour logic) and update the game board UI component.
